...
function scriptsCopyMin() {
  return gulp.src(paths.scripts_min.src).pipe(gulp.dest(paths.scripts_min.dest));
}
...
function copyRemaining() {
  return gulp.src(paths.publicRoot.src).pipe(gulp.dest(paths.publicRoot.dest));
}

function copyAutocompleteJSON() {
  return gulp.src(paths.autocompleteJSON.src).pipe(gulp.dest(paths.autocompleteJSON.dest));
}

exports.default = parallel(images, views, scripts, scriptsCopyMin, css, copyRemaining, copyAutocompleteJSON);
