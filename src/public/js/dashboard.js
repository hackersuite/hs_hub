$(document).ready(function () {
  ...
  function checkTwitchStatus() {
    $.get({
      ...
      updateTwitchStatus(data);
    });
  }
  
  const onlineTemplate = `
  <span class="material-icons" style="color: red">rss_feed</span>
  <div class="stats" style="color: red">Live now!</div>`;
  const offlineTemplate = `
  <div class="stats">Currently Offline</div>`;
  function updateTwitchStatus(isOnline) {
